                    ...
                    <div className="absolute inset-1 bg-gray-800 rounded-lg z-10 p-5">
                        ...
                        <div className="text-center font-sans mb-10 bg-gray-800 ">
                            ...
                            <div className="relative flex flex-col mb-2">
                                ...
                                <div>
                                    <span className=" font-medium text-gray-100">Username</span><input name="name" className="shadow pb-2 appearance-none border rounded w-full py-2 px-3 text-gray-100 bg-lime-500 leading-tight focus:outline-none focus:shadow-outline" type="text" value={cred.name} onChange={handleCreds} placeholder="Enter your name" required />
                                </div>
                                <div className="mt-3">
                                ...
                                focus:outline-none text-white font-bold py-2 px-3 rounded w-full" type="button" onClick={saveData}>
                                    ...
                                    <div className="mt-2 content-center text-center">
                                        <h3 className="text-center font-medium text-sm text-gray-100">Already have an account? <span className="text-lime-500 cursor-pointer" onClick={login}>Login</span></h3>
                                    </div>
                                </div>
                                </div>
                            </form>
